...
func TestNormalizeEmail(t *testing.T) {
	cases := []struct{ in, want string }{
		...
		{"ann.jose+home@gmail.com", "annjose@gmail.com"},
		{"ann.jose@gmail.com", "annjose@gmail.com"},
		{"ann.jose@googlemail.com", "annjose@googlemail.com"},
		{"ann.jose@fastmail.com", "ann.jose@fastmail.com"},
